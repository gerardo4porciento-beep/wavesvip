...
export const BOATS: BoatConfig[] = [
    {
        ...
        capacity: 6,
        calendarId: process.env.NEXT_PUBLIC_CALENDAR_ID_6_PAX || "primary",
        price: 230,
        description: "Lancha Deportiva tipo Open. Ideal para parejas o grupos pequeños.",
    },
    {
        id: "boat-8-pax",
        name: "Lancha Deportiva 8 Pax",
        capacity: 8,
        calendarId: process.env.NEXT_PUBLIC_CALENDAR_ID_8_PAX || "primary",
        price: 250,
        description: "Lancha Deportiva tipo Open. Espaciosa y cómoda.",
    },
    {
        id: "boat-10-pax",
        name: "Lancha Deportiva 10 Pax",
        capacity: 10,
        calendarId: process.env.NEXT_PUBLIC_CALENDAR_ID_10_PAX || "primary",
        price: 300,
        description: "Lancha Deportiva tipo Open. Lujo accesible para grupos medianos.",
    },
    {
        id: "boat-12-pax",
        name: "Lancha Deportiva 12 Pax",
        capacity: 12,
        calendarId: process.env.NEXT_PUBLIC_CALENDAR_ID_12_PAX || "primary",
        price: 320,
        description: "Lancha Deportiva tipo Open. La experiencia definitiva.",
    },
];
